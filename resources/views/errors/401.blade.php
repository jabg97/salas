...
<div class="card col-md-10 col-lg-10 col-sm-10 mx-auto float-xs-none white z-depth-5 hoverable py-2 px-2">
 ...
 <div class="form-header red darken-3 z-depth-5 hoverable">
            <h1 class="nb-error-title"><i class="fa fa-exclamation-circle left"></i><strong> Error 401</strong></h1>
        </div>
...
<div class="subimg">
<img src="{{ asset('img/exception/403.png') }}" class="img-fluid lost-error-img" alt="401"/>
                    </div>
                    </div>
                    <br>
