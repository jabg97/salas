...
<div class="card col-md-12 col-lg-12 col-sm-12 mx-auto float-xs-none white z-depth-5 hoverable py-2 px-2">
 ...
 <div class="form-header red darken-3 z-depth-5 hoverable">
            <h3><i class="fa fa-pencil"></i><strong> Editar Equipo #{{ $equipo->id }} de {{ $sala->nombre }} </strong></h3>
        </div>
<center>

  <div class="col-md-10 col-lg-10 col-sm-10 col-xs-10">

{{ Form::model($equipo, array('route' => array('equipos.update', $equipo->id), 'method' => 'PUT')) }}

<div class="md-form">
        {{ Form::number('ram', null, array('class' => 'form-control validate','title' => 'Ingrese solo numeros','pattern' => '[0-9]')) }}
...
<br/>
    <div class="md-form">
        {{ Form::number('hdd', null, array('class' => 'form-control validate','title' => 'Ingrese solo numeros','pattern' => '[0-9]')) }}
...
<br/>
 <div class="md-form">
        {{ Form::text('so', null, array('class' => 'form-control validate')) }}
...
<br/>
     <div class="md-form">
        {{ Form::text('monitor', null, array('class' => 'form-control validate')) }}
...
<div class="md-form">
        {{ Form::textarea('observacion', null, array('class' => 'form-control validate md-textarea','size' => '30x5')) }}
...
<div class="form-group">
        ...
        <br/>
        {{ Form::select('sala',$salas, null, array('class' => 'form-control custom-select')) }}
    </div>
 @if ($errors->has('sala'))
   <div class='error alert bg-danger waves-effect text-white z-depth-4 hoverable imenn'> <span  class="close" data-dismiss="alert" aria-label="close">&times;</span><center><strong> <i class='fa fa-1x fa-times left'></i>&nbsp;&nbsp;Error!</strong>
...
@endphp
        ...
        {{ Form::select('tipo_procesador', array('1' => 'x86', '2' => 'x64', '3' => 'arm', '4' => 'arm64'), $index, array('class' => 'form-control custom-select')) }}
    </div>
...
<br/>
 ...
 <div class="form-group">
        ...
        {{ Form::date('fecha_mantenimiento',null, array('class' => 'form-control validate')) }}
    </div>
...
@if ($equipo->activo)
  ...
  <label class="btn btn-success">
        {{ Form::radio('activo','1', false) }} Activo
  </label>
  <label class="btn btn-danger active">
    {{ Form::radio('activo','0', true) }} Inactivo
  </label>
</div>@endif
...
<br/>
    ...
    {{ Form::submit('Editar Equipo', array('class' => 'btn btn-unique')) }}
